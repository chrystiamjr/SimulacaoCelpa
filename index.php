	...
	<div class="form-horizontal">
		<div class="widget wblue">
			...
			<div class="widget-content">
				<div class="padd">
					...
					<div class="form-group">
						...
						<div class="col-lg-9">
							<input type="text" class="form-control" id="cpfLogin" pattern=".{14,}" required maxlength="14"
							       OnKeyPress="formatar('###.###.###-##', this)" placeholder="CPF">
						</div>
					</div>
					<!-- Password -->
					<div class="form-group">
			...
			<div class="widget-foot">
				...
				<button type="reset" class="btn btn-default pull-right" id="limpaDados">Limpar campos</button>
			</div>
		</div>
...
<script>
	...
	$("#loginSistema").click(function () {
		...
		$('#inputPassword').removeClass('label-danger');
		if($('#cpfLogin').val() != "" && $('#inputPassword').val() != "") {
			...
			$('#cpfLogin').addClass('label-danger');
			$('#inputPassword').addClass('label-danger');
		}
	})
