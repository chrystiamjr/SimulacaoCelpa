<?php
require_once "../../database/dbObra.php";
$obr = new dbObra();
?>
	<!DOCTYPE html>
	<html lang="en">
	...
	<div class="content">
		...
		<div class="mainbar">
			...
			<div class="page-head" style="background-color: #31708f;">
				<h2 class="pull-left" style=" color: white">Obras
					<span class="page-meta" style=" color: white"><i class="fa fa-user-circle" aria-hidden="true"></i> Cadastro de obras</span>
				</h2>
				<!-- Breadcrumb -->
				<div class="bread-crumb pull-right">
					...
					<a href="#" class="bread-current" style=" color: white">Obras</a>
				</div>
				...
				<div class="container">
					...
					<div class="col-md-12">
						<div class="pull-right" style="margin-right: 10px;margin-bottom: 10px; font-size: 40px;">
							<button type="button" class="addObra" data-toggle="modal" data-target="#Adicionar">
								<i class="fa fa-plus-circle" aria-hidden="true"></i>
							</button>
						</div>
						<table class="table table-bordered" id="listaObras">
							...
							<tbody align="center">
							<?php if($obr->listarTodosObra() != null){ foreach ($obr->listarTodosObra() as $dado) { ?>
								<tr style="font-size: 12px">
									<td style="vertical-align: middle;"><?php echo $dado['id_obras']; ?></td>
									...
									<td style="vertical-align: middle;font-size: 18px;">
										<button class="addObra editar" title="Editar" style="margin: 0" data-toggle="modal" data-target="#Editar">
											<input type="hidden" class="editaID" value="<?php echo $dado['id_obras']; ?>">
										...
										<button class="addObra remover" title="Remover" style="margin: 0" data-toggle="modal" data-target="#Deletar">
											<input type="hidden" class="editaID" value="<?php echo $dado['id_obras']; ?>">
	...
	<script type="text/javascript">
		...
		$(".editar").click(function(){
			...
			$('#descricaoObraEditar').val(desc);
			$('#siglaObraEditar').val(sig);
			$('#idObra').val(id);
		});

		$(".remover").click(function(){
			var id = $(this).find('.editaID').val();
			$('#idObraRemover').val(id);
		});
