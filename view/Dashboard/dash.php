      ...
      <div class="mainbar">
        ...
        <div class="matter">
          <div class="container">
            ...
            <div class="pull-right" style="margin-right: 25px;margin-bottom: 10px; font-size: 40px;">
              <a type="button" class="addColaborador" href="gerarPlanilha.php">
            ...
            <div class="col-md-12 table-responsive">
              ...
              <div id="Tab1">
                <table class="table table-bordered listaRelacionamento">
                  ...
                  <tbody align="center">
                    <?php if ($relacionamento->listarEquipes_ColaboradorEquipe() != null || $relacionamento->listarEquipes_ColaboradorEquipe() != false) {
                      foreach ($relacionamento->listarEquipes_ColaboradorEquipe() as $dado) {
                        ...
                        <tr style="font-size: 12px">
                          ...
                          <td style="vertical-align: middle;font-size: 18px;">
                            <button class="relacionamento listaColaboradores" title="Listar Colaboradores" style="margin: 0"
                                    data-toggle="modal" href="#listarColaboradoresPorEquipes" data-backdrop="static"
                                    data-keyboard="false">
                              <input type="hidden" class="idEquipe" value="<?php echo $dado['id_equipes']; ?>">
                              <i class="fa fa-address-card" aria-hidden="true"></i>&nbsp;
                            </button>
                            <button class="relacionamento listaEPC" title="Listar EPCs" style="margin: 0"
                                    data-toggle="modal" href="#listaEPCPorEquipe" data-backdrop="static"
                                    data-keyboard="false">
                              <input type="hidden" class="idEquipe" value="<?php echo $dado['id_equipes']; ?>">
                              <i class="fa fa-fire-extinguisher" aria-hidden="true"></i>&nbsp;
                            </button>
                            <button class="relacionamento listaFerramenta" title="Listar Ferramentas" style="margin: 0"
                                    data-toggle="modal" href="#listaFerramentaPorEquipe" data-backdrop="static"
                                    data-keyboard="false">
                              <input type="hidden" class="idEquipe" value="<?php echo $dado['id_equipes']; ?>">
                              <i class="fa fa-wrench" aria-hidden="true"></i>&nbsp;
                            </button>
                            <button class="relacionamento removerTudoPorEquipe" title="Remover" style="margin: 0"
                                    data-toggle="modal" data-target="#DeletarUmColaboradorPorEquipe" data-backdrop="static"
                                    data-keyboard="false">
