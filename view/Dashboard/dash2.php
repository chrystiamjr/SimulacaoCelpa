		...
		<div class="mainbar">
			...
			<div class="page-head" style="background-color: #31708f;">
				...
				<div class="bread-crumb pull-right">
					<a href="/SimulacaoCelpa/view/Dashboard/dash2.php" style=" color: white"><i class="fa fa-home"></i> Página
						Inicial</a>
					<!-- Divider -->
						...
						<div class="container">
							<h4 align="center">Equipes/Colaboradores
								<div class="pull-right" style="position:relative; bottom: 4px; font-size: 40px;">
									<button type="button" class="relacionamento" data-toggle="modal"
									        data-target="#DeletarTodosColaboradoresPorEquipe">
									...
									foreach ($relacionamento->listarEquipes_ColaboradorEquipe() as $dado) { ?>
										<tr style="font-size: 12px">
											...
											<td style="vertical-align: middle;font-size: 18px;">
												<button class="relacionamento listaColaboradores"  title="Listar Colaboradores" style="margin: 0" data-toggle="modal" href="#listarColaboradoresPorEquipes">
...
<?php include_once 'modalDash2.php';