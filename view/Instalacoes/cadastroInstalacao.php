				...
				<div class="table-responsive">
					...
					<table class="table table-bordered" id="listaInstalacao">
						...
						<tr>
							...
							<th style="color: white; text-align: center;vertical-align: middle">Ativos</th>
							<th style="color: white; text-align: center;vertical-align: middle">Sigla</th>
							<th style="color: white; text-align: center;vertical-align: middle">Código Equatorial Ativos</th>
							<th style="color: white; text-align: center;vertical-align: middle">Ações</th>
						</tr>
						</thead>
						<tbody align="center">
						<?php if($inst->listarTodosInstalacaoComAtivos() != null){ foreach ($inst->listarTodosInstalacaoComAtivos() as $dado) { ?>
							<tr style="font-size: 12px">
								...
								<td style="vertical-align: middle;"><?php echo $dado['nm_ativo']; ?></td>
								<td style="vertical-align: middle;"><?php echo $dado['sigla_ativo']; ?></td>
								<td style="vertical-align: middle;"><?php echo $dado['codigo_equatorial']; ?></td>
								<td style="vertical-align: middle;font-size: 18px;">
									<button class="addInstalacao editar" title="Editar" style="margin: 0" data-toggle="modal" data-target="#Editar">
										...
										<input type="hidden" class="editaAtivo" value="<?php echo $dado['nm_ativo']; ?>">
										<input type="hidden" class="editaAtivoSigla" value="<?php echo $dado['sigla_ativo']; ?>">
